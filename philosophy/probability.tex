...
here.  A key idea I want to convey is that if you think about the
...
\quad ;
\end{eqnarray}
this is the definition of ``independent data points''.  If all the
functions $p(a_n \given c)$ are identical---that is, if the functions
don't depend on $n$---we say the data are ``iid'' or ``independent and
