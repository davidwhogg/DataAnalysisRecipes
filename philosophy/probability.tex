...
%   - etc
% - Incorporate Phil comments (in shoulder bag)
...
That's why it is so important (and unloved by frequentists).\note{The
  ...
  Bayesian.  The Bayesian gets new capabilities in exchange for these
  new assumptions, but they \emph{are} new.}
