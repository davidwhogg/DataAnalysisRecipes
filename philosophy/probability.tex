...
of consistent models, you can't answer questions like ``are these
parameters more plausible than these?''\note{It is hard to live as a
  frequentist but it is possible.  Some of the aforementioned battles
  between frequentists and Bayesians are set off by
  over-interpretation of a likelihood as a posterior pdf; in these
  cases the investigator is indeed unconsciously multiplying in a
  prior.  Other battles are set off by loose language in which a
