...
\section*{DRAFT 2012-03-10:\ Data analysis recipes:\ \\
  Probability theory\footnotemark}
...
\begin{abstract}
I review probability calculus for the rusty.  I connect the rules of
probability theory (really just the rules of measure theory) to the
operations performed in probabilistic data analysis.
\end{abstract}

\noindent
What is my goal in writing this \documentname?
