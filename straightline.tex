...
\begin{abstract}
  ...
  of a posterior probability distribution is required if there are
...
hold.\note{Even in situations in which linear fitting is appropriate,
  ...
  uncertainties s are negligible are put into the $\mY$ vector and the
...
\begin{figure}[htbp]
\begin{center}%
\includegraphics[width=0.5\textwidth]{exMix1a}%
\includegraphics[width=0.5\textwidth]{exMix1b}%
\end{center}
...
\begin{figure}[htbp]
\begin{center}%
\includegraphics[width=0.5\textwidth]{exMix1c}%
\includegraphics[width=0.5\textwidth]{exMix2c}%
\end{center}
