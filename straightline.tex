...
in \equationname~(\ref{eq:objectivei}).  If the uncertainty
distribution can be expressed as the sum of $k$ Gaussians (as all
probability distributions can), these likelihoods become
\begin{equation}
