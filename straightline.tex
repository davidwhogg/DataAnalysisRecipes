...
\newcounter{solution}
\newenvironment{solution}{\paragraph{\solutionname~\thesolution:}\refstepcounter{solution}}{}
...
data points 5--20 in \tablename~\ref{table:data_allerr}.  Make a plot
