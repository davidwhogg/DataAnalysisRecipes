...
% - emphasize the importance of marginalization and that it forces Bayesianism
...
% Combine this next section with non-gaussian errors.  Open with the
% comment that, in some sense, outliers can be seen as examples of non-
% gaussian errors; how to deal?  Softening is usually ad-hoc; modeling
% them realistically is justified.
