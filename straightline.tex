...
\footnotetext{%
  ...
  license\note{\label{note:first}%
    Copyyright 2010 by the authors.  You may copy and distribute this
    document provided that you make no changes to it whatsoever.}  and
  the acknowledgements\note{%
    We owe a debt above all to Sam Roweis (Toronto \& NYU, now
    deceased), who taught us to find and optimize justified scalar
    objective functions.  In addition it is a pleasure to thank Mike
