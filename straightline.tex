...
$(m,b)$ of the line.  In standard parlance, the probability of the
observations given model parameters $(m,b)$ is called the
\emph{likelihood} of the parameters given the observations.  We will
now construct this likelihood and maximize it, or else multiply it by
...
\begin{problem}
Take the data from Tables~?? and ??.  Fit a straight line to the $y$
