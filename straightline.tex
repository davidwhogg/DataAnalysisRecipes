% to-do
% -----
% - Hogg: cite and criticize ``sixlin'' paper
...
\section*{Data analysis recipes:\ \\
  Fitting a straight line to data\footnote{
    ...
    This is a DRAFT version dated 2009-08-31.
...
Hogg:  This would be a good time to discuss the sixlin paper.  Hogg

Note that not only does the standard problem solved in this
\sectionname\ have a linear solution, the objective function
``landscape'' is \emph{convex} so the solution is unique.  This is
...
likelihoods for a ``bag of models'' if you are a frequentist!  Hogg
