...
data points 5 through 20 in \tablename~\ref{table:data_allerr}.  Make a plot
...
anything you don't like about the result?  Is there anything different
about the new points you have included beyond those used in
...
which is \emph{way} beyond the scope of this document (cite some
...
model is bad.  Two extremely common reasons $\chi^2$ can be lower...Hogg
...
Hogg: Why you shouldn't reject
models on a $\chi^2$ basis alone.
...
\begin{comments}
Hogg: Contrast model comparison with model rejection.  Note the
difference between the $\sqrt{N-2}$ and the 1 of model comparison.
...
{\bf{Solution to \problemname~\ref{prob:easy}:}}
\begin{figure}[H]
\includegraphics[]{ex1.png}
\caption{Solution to \problemname~\ref{prob:easy}}\label{fig:ex1}
\end{figure}


{\bf{Solution to \problemname~\ref{prob:standard}:}}
\begin{figure}[H]
\includegraphics[]{ex2.png}
\caption{Solution to \problemname~\ref{prob:standard}}\label{fig:ex2}
\end{figure}

{\bf{Solution to \problemname~\ref{prob:quadratic}:}}
\begin{figure}[H]
\includegraphics[]{ex3.png}
\caption{Solution to \problemname~\ref{prob:quadratic}}\label{fig:ex3}
\end{figure}
