...
inference.\note{Posterior probability distribution functions and
  ...
  or conflicts with the prior used in making the posterior sampling,
  he or she will need access not just to the posterior probability
  distribution function but to the likelihood function.  It is the
  likelihood function that contains all the information about the
  data---all the new information generated by the experiment---and
