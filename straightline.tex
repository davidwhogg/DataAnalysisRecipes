% to-do
% -----
% - Bovy: make figures for all problems that call for figures
...
\caption{Solution to \problemname~\ref{prob:chi2}. The gray vertical line is the mean of the uncertainty variances $\sigma_{yi}^2$; the dashed line corresponds to $\chi^2 = N -2$.}\label{fig:chi2}
\end{figure}
