...
% - Hogg: add a problem or two that reduces the error bars and shows that it leads to massive rejection.
% - Hogg: mention linear regression -- which is usually least squares without the errors!
