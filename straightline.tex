...
values of points XX--XX in \tablename~\ref{table:data_allerr}.  Make a
plot showing the points, their two-dimensional uncertainties (show
them as one-sigma ellipses), and the best-fit line.
\end{problem}
...
\begin{problem}
Take the data from \tablename~\ref{table:data_allerr}.  Fit a straight
line to the $y$ values of the points XX--XX, using the $y$-direction
