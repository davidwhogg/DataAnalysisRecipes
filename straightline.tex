...
model.\note{When fitting is used for data-driven prediction---that is,
  ...
  not a good or appropriate model.  A full discussion of this is
  beyond the scope of this \documentname, especially since in
  astrophysics and other observational sciences it is relatively rare
  that data prediction is the goal of fitting.}  For these
reasons---and the reason that in rare cases the fit \emph{is}
justifiable and essential---the problem of fitting a line to data
comes up very frequently in the life of a scientist.
...
maximum likelihood; the standard uncertainty on the MAP answer would be
