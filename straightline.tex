...
data). Complementary to this, one of the amusing things about the
Bayesian posterior for the data rejections $\allq$ developed above is
that you can pick a particular data point $J$ and marginalize over
...
general methods exist \citep{bovy,kelly07}.
...
\bibitem[Isobe \etal(1990)]{isobe90}
  ...
  \textit{Astrophysical Journal} \textbf{364} 104--113.
\bibitem[Kelly(2007)]{kelly07}
  Kelly,~B.~C.\ 1990,
  Some aspects of measurement error in linear regression of astronomical data
  \textit{Astrophysical Journal} \textbf{665} 1489--1506.
