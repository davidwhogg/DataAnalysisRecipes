% to-do
% -----
% - Hogg: see Bovy email of 2010-04-20 or -21
% - Hogg: re-combine outlier and fg-bg sections noting marginalization relation
...
when you combine data sets from different sources (though it is rare
that one has reliable information about the unreliability of one's
data).

Complementary to this, one of the amusing things about the Bayesian
posterior for the data rejections $\allq$ developed above is that you
...
probability that individual data points are bad.  This is possible
...
point is good (or bad, depending on the direction of the ratio and
...
the marginalized odds that data point $i$ is good.
...
difficulty---in most problems of interest---pales in comparison to the
difficulty of writing down a justifiable or even approximate
