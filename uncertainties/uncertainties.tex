...
\emph{permitting the other parameters
  to vary} or including the uncertainty that comes from the fact that you don't know
...
uncertainty tensor $\tC_a\inv$? This is sometimes called the \textsl{precision
  matrix} or \textsl{information tensor}.
...
of the information tensor $\tC_a\inv$ is not a
conservative uncertainty on parameter $a_k$.\footnote{A figure demonstrating this
  difference would be cool! Hogg}
We will return to this discussion in more detail below in
\sectionname~\ref{sec:nuisances}.

And what is the interpretation of the off-diagonal elements of the uncertainty
tensor $\tC_a$? HOGG SAY THINGS...
