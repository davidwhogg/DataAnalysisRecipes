...
about parameters and models.  In many cases of importance---as with making a discovery or
...
right move to choose the \emph{most probable} model or option; it is rare
...
officer who demands a number, or an editor who wants you to put a
...
and frequencies for data and parameters.

It is typical in situations like this---for the star brightness or the
fraction of consumers---to report the \emph{maximum likelihood} value
of the quantity of interest.  This is not a bad choice!  However, it
is definitely a choice, and it comes with significant costs and
benefits.

...For example...imagine the star brightness makes it the most absurd
star that has ever existed...imagine that the consumer fraction means
that you ship no units...etc...

...classification...False-positive and false-negative rates...
